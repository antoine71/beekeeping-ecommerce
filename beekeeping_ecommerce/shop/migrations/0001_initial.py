...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_id', models.CharField(max_length=40, unique=True, verbose_name='User id (session_key)')),
                ('first_name', models.CharField(default='Anonymous', max_length=100, verbose_name='Prénom')),
                ('last_name', models.CharField(default='User', max_length=100, verbose_name='Nom')),
